...
export const headerStyles = {
  ...
  header:
    "sticky top-0 z-[1100] w-full shrink-0 border-b border-white/10 bg-[#1a3e75] shadow-md transition-all duration-300",
  ...
  linkActive:
    "text-white font-medium after:absolute after:bottom-0 after:left-3 after:right-3 after:h-[1px] after:w-[calc(100%-24px)] after:bg-white",
};
