...
export function CartNavButton() {
  ...
  return (
    <Link
      href="/cart"
      className="relative flex items-center gap-2 rounded border border-white/30 bg-white/10 px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-[#2248b3]"
