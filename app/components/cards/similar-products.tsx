      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={!canGoBack}
            className="rounded border border-slate-300 p-2 text-slate-600 transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        {visibleProducts.map((product) => (
          <Link
            ...
            className="group border border-slate-200 transition-colors hover:border-slate-300"
          >
